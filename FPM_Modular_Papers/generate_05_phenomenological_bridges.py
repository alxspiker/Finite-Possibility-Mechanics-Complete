...
def manuscript(st):
    s = [
        ...
        body("This gives a ceiling at v<sub>*</sub>=0.9995077253c, p<sub>*</sub>/(mc)=31.85817, and tau<sub>max</sub>=70.0263 microseconds for tau<sub>mu</sub>=2.1969811 microseconds. The supplied historical reference gamma=29.3 lies below the conditional ceiling, so it does not distinguish this extension from the imported low-load kinematic map.", st),

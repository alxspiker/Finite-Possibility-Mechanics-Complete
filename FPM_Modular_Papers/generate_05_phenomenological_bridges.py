...
def manuscript(st):
    s = [
        ...
        body("A separate canonical edge diagnostic tests whether the first master-chain action state admits a scalar temperature under a route-energy dictionary. Across 375 undirected edges after the tick-zero truth-target update, it gives corr(Delta L, ln[P<sub>ij</sub>/P<sub>ji</sub>])=0.00469041, beta*= -0.00183473, and normalized residual 0.99999401. This state therefore fails that proposed canonicality criterion.", st),
